...
export default function ArtworkFilter({ currentMedium, mediums }: ArtworkFilterProps) {
  return (
    <div className="mb-12">
      <p className="text-sm text-stone uppercase tracking-widest mb-4">Filter by Medium</p>
        ...
        <Link
          ...
          className={clsx(
            ...
            !currentMedium
              ...
              : 'bg-transparent text-stone border-cloud hover:text-ink hover:border-silver'
          )}
        >
          All Works
        </Link>
